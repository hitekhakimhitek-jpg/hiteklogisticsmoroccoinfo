...
const EXACT: Record<string, string> = {
  ...
  "Regulations and binding obligations the company tracks, with status and owner.":
    "Réglementations et obligations contraignantes suivies par l'entreprise, avec statut et responsable.",
  "Active geographic disruptions affecting trade lanes and operations.":
    "Perturbations géographiques actives affectant les routes commerciales et les opérations.",
  "No items. Add your first compliance obligation.":
    "Aucun élément. Ajoutez votre première obligation de conformité.",
  "No disruptions logged yet.": "Aucune perturbation enregistrée.",
  ...
  // ChangeSummaryBanner — split text nodes (number is a separate node)
  "new today": "nouveau(x) aujourd'hui",
  critical: "critique(s)",
  "require action": "nécessite(nt) une action",
  sources: "sources",

  // Reports — extra UI strings
  ...
  "Done!": "Terminé !",
  "Weekly report generated!": "Rapport hebdomadaire généré !",
  "Monthly summary generated!": "Résumé mensuel généré !",
  ...
  "🇲🇦 Morocco Weekly Digest": "🇲🇦 Résumé hebdomadaire Maroc",
  "🇲🇦 Morocco Monthly Digest": "🇲🇦 Résumé mensuel Maroc",
  rising: "en hausse",
  declining: "en baisse",
  stable: "stable",
  urgent: "urgent",
