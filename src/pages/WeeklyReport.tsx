  ...
  <div className="p-6 lg:p-8 max-w-7xl mx-auto">
    <div className="flex items-center gap-3 mb-6">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">Structured weekly intelligence briefing</p>
      </div>
    </div>
    <div className="bg-card rounded-lg border border-border card-elevated p-8 text-center">
      <p className="text-muted-foreground">Weekly report generation coming in Phase 2.</p>
    </div>
  </div>
);
