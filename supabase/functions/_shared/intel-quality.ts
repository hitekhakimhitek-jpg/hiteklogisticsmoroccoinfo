...
const OPERATIONS = new RegExp(`${MARITIME.source}|trucking|road freight|air cargo|airport cargo|rail freight|transport strike|port congestion|capacity disruption|route disruption`, "i");
